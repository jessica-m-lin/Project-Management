...
CREATE TABLE Practice_Location_Info(application_id INTEGER, service_type INTEGER, practice_name_in_directory TEXT, practice_name_in_w9 TEXT, practice_location_primary INTEGER, practice_address TEXT, practice_city TEXT, practice_state_or_country TEXT, practice_postal_code TEXT, 
